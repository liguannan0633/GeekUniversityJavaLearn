package com.geek.learn.statemachine.service.impl;

import com.geek.learn.statemachine.Order;
import com.geek.learn.statemachine.OrderStatus;
import com.geek.learn.statemachine.OrderStatusChangeEvent;
import com.geek.learn.statemachine.service.OrderService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Order create() {
        ...
        System.out.println("创建订单,order:{}" + order.toString());
        return order;
    }
    @Override
